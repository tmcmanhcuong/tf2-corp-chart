...
| **opensearch** | ECR `…/opensearch:<tag>` (custom build from `opensearchproject/opensearch:3.2.0`) | Search and log analytics engine. Requires a writable root filesystem for runtime storage, logs, locking, and temporary java process directories. |
