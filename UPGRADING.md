...
> [!NOTE]
> The TechX Corp Platform does not support being upgraded from one version to
...
the [#1788](https://github.com/open-telemetry/techx-corp/issues/1788)
issue in the TechX Corp Platform repository. Any custom configuration for a Demo
...
will have to delete all existing techx-corp deployments before running
